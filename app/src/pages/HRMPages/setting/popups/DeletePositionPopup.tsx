...
export function DeletePositionPopup({ open, onClose, onDelete, positionName }: Props) {
  return (
    <Modal open={open} onClose={onClose} lockScroll>
      <div className="w-[420px] max-w-[95vw] overflow-hidden rounded-xl bg-white shadow-2xl">
        ...
        <div className="flex items-center justify-between px-6 pt-5 pb-3">
          <h2 className="text-[17px] font-bold text-slate-800">Delete Position</h2>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="px-6 pb-6 pt-2">
          <p className="text-[14px] text-slate-600 leading-relaxed">
            ...
            <span className="font-bold text-slate-800">{positionName}</span>? This action cannot
            be undone.
          </p>
