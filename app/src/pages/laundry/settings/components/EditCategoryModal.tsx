...
interface EditCategoryModalProps {
  isOpen: boolean;
  category: LaundryInventoryCategoryReadDto | null;
  onConfirm: (id: number, name: string) => void;
  onCancel: () => void;
  isSaving: boolean;
}

export function EditCategoryModal({ isOpen, category, onConfirm, onCancel, isSaving }: EditCategoryModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-6">
        ...
        <h2 className="text-[18px] font-bold text-slate-800 text-center mb-1">Edit Category</h2>
        <p className="text-[13px] text-slate-400 text-center mb-5">Update the name for this category.</p>
