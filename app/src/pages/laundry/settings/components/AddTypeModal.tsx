...
export function AddTypeModal({ isOpen, onConfirm, onCancel, isSaving }: AddTypeModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-6">
        ...
        <h2 className="text-[18px] font-bold text-slate-800 text-center mb-1">Add New Type</h2>
        <p className="text-[13px] text-slate-400 text-center mb-5">
          Enter a name for the new laundry type.
        </p>
