...
export type LaundryInventoryTab =
  | 'Stock Overview'
  | 'Withdraw Items'
  | 'Transactions'
  | 'Low Stock'
...
export const LAUNDRY_INVENTORY_TABS: LaundryInventoryTab[] = [
  'Stock Overview',
  'Withdraw Items',
  'Transactions',
  'Low Stock',
...
interface LaundryInventoryTabsProps {
  activeTab: LaundryInventoryTab;
  onTabChange: (tab: LaundryInventoryTab) => void;
}

export function LaundryInventoryTabs({ activeTab, onTabChange }: LaundryInventoryTabsProps) {
  return (
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-6">
      <div className="flex overflow-x-auto rounded-xl border border-slate-200 bg-white shadow-sm flex-grow max-w-4xl">
        {LAUNDRY_INVENTORY_TABS.map((tab) => {
