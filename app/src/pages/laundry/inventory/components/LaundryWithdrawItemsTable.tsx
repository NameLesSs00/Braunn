...
import type { LaundryInventoryItemReadDto, LaundryItemStatus } from '../../../../models/Laundrymodels/LaundryInventoryItem';
...
export function LaundryWithdrawItemsTable() {
  const dispatch = useAppDispatch();
  const { items: allItems } = useAppSelector((state) => state.laundryInventoryItems);
