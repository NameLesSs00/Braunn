...
export function Modal({ isOpen, onClose, title, subtitle, children, maxWidth = 'max-w-xl' }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className={`relative w-full ${maxWidth} bg-white rounded-2xl shadow-xl overflow-hidden max-h-[90vh] flex flex-col`}>
        {/* Header */}
        <div className="bg-[#0a4bbd] px-8 py-6 shrink-0">
