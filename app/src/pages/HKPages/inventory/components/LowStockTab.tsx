...
interface LowStockCardProps {
  item: HkmInventoryItemReadDto;
  onRequestClick: () => void;
}

function LowStockCard({ item, onRequestClick }: LowStockCardProps) {
  const needed = item.minimumStock && item.minimumStock > item.quantity 
...
export function LowStockTab({ items }: LowStockTabProps) {
  ...
  const [selectedItem, setSelectedItem] = useState<HkmInventoryItemReadDto | undefined>(undefined);
