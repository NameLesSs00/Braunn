...
interface AddLostFoundCategoryModalProps {
  isOpen: boolean;
...
export function AddLostFoundCategoryModal({ isOpen, onConfirm, onCancel, isSaving }: AddLostFoundCategoryModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-6">
        ...
        <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-[#EEF4FF] mx-auto mb-4">
          {/* @ts-ignore */}
          <FiTag className="w-6 h-6 text-[#0a4bbd]" />
        </div>

        <h2 className="text-[18px] font-bold text-slate-800 text-center mb-1">Add L&F Category</h2>
        <p className="text-[13px] text-slate-400 text-center mb-5">
          Enter a name for the new Lost &amp; Found category.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g. Phones, Wallets, Jewellery…"
