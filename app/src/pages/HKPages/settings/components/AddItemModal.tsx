...
import { createHkmInventoryItem } from '../../../../features/HKfeatures/hkmInventoryItems/hkmInventoryItemsSlice';
        ...
        <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between bg-white shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[13px] text-slate-400">Create a new inventory item</p>
            </div>
          </div>
