...
interface EditUnitModalProps {
  isOpen: boolean;
  unit: HkmInventoryUnitReadDto | null;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-6">
        ...
        <h2 className="text-[18px] font-bold text-slate-800 mb-1">Edit Unit</h2>
        <p className="text-[13px] text-slate-400 mb-5">Update the name of this inventory unit.</p>
