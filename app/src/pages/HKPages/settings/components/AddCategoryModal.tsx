...
export function AddCategoryModal({ isOpen, onConfirm, onCancel, isSaving }: AddCategoryModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-6">
        ...
        <h2 className="text-[18px] font-bold text-slate-800 text-center mb-1">Add New Category</h2>
        <p className="text-[13px] text-slate-400 text-center mb-5">Enter a name for the new inventory category.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g. Cleaning Supplies, Linens…"
