...
interface AddPerRoomPricingPopupProps {
  onClose: () => void
}

export function AddPerRoomPricingPopup({ onClose }: AddPerRoomPricingPopupProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm">
      <div className="w-full max-w-3xl bg-white rounded-xl shadow-xl overflow-hidden flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-5 bg-[#004bb4]">
          <h2 className="text-xl font-bold text-white tracking-wide">Add Per Room Pricing</h2>
          <button 
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          {/* Room Type */}
          <div>
            <label className="block text-[13px] font-bold text-slate-600 mb-2">Room Type<span className="text-red-500 ml-0.5">*</span></label>
