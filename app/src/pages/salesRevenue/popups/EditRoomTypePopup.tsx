...
interface EditRoomTypePopupProps {
  onClose: () => void;
  // room: any; // In a real app we'd pass the room being edited and pre-fill data.
}

export function EditRoomTypePopup({ onClose }: EditRoomTypePopupProps) {
  return (
      ...
      <div className="bg-white w-full max-w-3xl rounded-xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] scale-in">
        ...
        <div className="bg-[#004bb4] text-white px-6 py-5 flex justify-between items-start">
          <div>
            ...
            <p className="text-blue-100 text-sm mt-1">Update room type information and pricing</p>
          </div>
