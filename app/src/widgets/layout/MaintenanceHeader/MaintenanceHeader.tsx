...
export function MaintenanceHeader({ NameMaintenance }: MaintenanceHeaderProps) {
  ...
  return (
    <>
      <header className="flex items-center justify-between gap-4 border-b border-slate-200 bg-white px-8 py-4">
        <h1 className="text-[22px] font-semibold text-slate-800">{NameMaintenance}</h1>

        <div className="flex items-center gap-4">
          <div className="relative" ref={notificationsRef}>
            <button
              type="button"
              className="relative grid h-10 w-10 place-items-center rounded-full border border-slate-200 bg-white shadow-sm transition-colors hover:bg-slate-50"
                      ...
                      {notifications.map((item) => (
                        ...
                        >
                          <div className="text-[13px] font-medium text-slate-800">
                            {item.type === 'maintenance_request_created' ? item.itemName || 'Maintenance Request' : 'Notification'}
                          </div>
                          {item.message && (
          ...
          <div className="relative" ref={profileRef}>
            ...
            >
              ...
              <div className="leading-tight text-left">
                <div className="text-[13px] font-semibold text-slate-800">Name+ HR</div>
